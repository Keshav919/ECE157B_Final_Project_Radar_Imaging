...
datasets = {adcData_breathing_heart_r1, adcData_breathing_heart_r2 , ...
    adcData_breathing_heart_t1, adcData_breathing_heart_t2, adcData_breathing_heart_t3, ...
    adcData_breathing_heart_t4};
...
% Range FFT
for a=1:6
adc_sampled = datasets{a}(100:end-10,:,:);
...
title("Unwrapped phase for motion compensated signal")
...
fprintf("The breathing rate for test " + num2str(a) + " is "+f(b_idx)+"Hz.\n")
